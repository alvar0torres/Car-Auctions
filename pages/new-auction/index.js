...
import classes from "../../styles/New-auction.module.css";
    ...
    <section className={classes.formSection}>
      <SimpleCard>
        <form onSubmit={onSubmitHandler} className={classes.form}>
          <TextField inputRef={inputModel} id="outlined-basic" label="Model" variant="outlined" />
          <TextField
          ...
          />
          <TextField inputRef={inputImage} id="outlined-basic" label="Picture (URL)" variant="outlined" />
          <TextField
